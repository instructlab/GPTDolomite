...
def _import_state_dict_from_huggingface(
    ...
    state_dict = {
        "transformer.wte.weight": safetensors_weight_manager.get_tensor(
            "model.embed_tokens.weight"
        ),
        "transformer.ln_f.weight": safetensors_weight_manager.get_tensor(
            "model.norm.weight"
        ),
    }
    ...
    for layer_idx in range(num_layers):
        ...
        state_dict[f"transformer.h.{layer_idx}.attn.c_attn.weight"] = (
            interleave_query_key_value_tensor_for_attention(
                safetensors_weight_manager.get_slice(
